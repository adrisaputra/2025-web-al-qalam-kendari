...
Route::get('/page-social', [WebController::class, 'social']);
Route::get('/page-social-list', [WebController::class, 'social_list']);
Route::get('/page-social-detail', [WebController::class, 'social_detail']);
