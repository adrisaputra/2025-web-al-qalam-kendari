...
<link rel="stylesheet" href="{{ asset('frontend/web/social_detail.css') }}" type="text/css" />
		...
		<div class="container clearfix">
			...
			<div class="heading-block border-0 mw-100">
				...
				<div class="row clearfix">
					...
					<div class="row" id="show_social">
						<div class="col-md-8 bottommargin">
							<div class="social-card" data-animate="fadeInUp" data-delay="100">
								<div class="social-body">
									<div class="breadcrumb">
										🏠 / <a href="#">Artikel </a>
									</div>

									<h3 class="social-heading" style="font-size: 22px;text-transform: none;margin-top:20px;margin-bottom:10px">{{ $social->title }}</h3>

									<div class="meta">
										<div class="meta-item">
											<span>⏱️ {{ \App\Helpers\Helpers::month_indo_full($social->created_at) }}</span>
										</div>
										<div class="meta-item">
											<span>👤 Ditulis oleh <strong>{{ $social->user->name }}</strong></span>
										</div>
										<div class="meta-item right">
											<span>👁️ Dilihat <strong>{{ $social->count_view }}</strong> kali</span>
										</div>
									</div>
									<div class="social-img">
										<img src="{{ asset('storage/upload/social/'.$social->cover) }}" alt="">
									</div>

									<p class="social-desc" style="color: #000000;">
										{!! $social->text !!}
									</p>
						...
						<div class="col-md-4 bottommargin">
							<div class="social-card" data-animate="fadeInUp" data-delay="200">
								<div class="social-body">
								...
								<div class="social-body">
									...
									@foreach($get_social as $i => $v)
									<div class="social-item">
										<img src="{{ asset('storage/upload/social/'.$v->cover) }}" alt="">
										<div class="social-info">
											<a href="{{ url('page-social-detail?q='.$v->slug) }}" class="judul">{{ $v->title}}</a>
											<div class="meta2">
												<!-- <span>📅 23 September 2025</span> -->
												<span>⏱️ {{ \App\Helpers\Helpers::month_indo_full($v->created_at) }}</span>
												<span>👁️ Dilihat {{ $v->count_view }} kali</span>
