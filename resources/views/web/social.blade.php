...
@extends('web.layout')
@section('content')
<link rel="stylesheet" href="{{ asset('frontend/web/social.css') }}" type="text/css" />
		...
		<div class="container clearfix">
			...
			<div class="heading-block border-0 mw-100">
				...
				<div class="row clearfix">
					...
					<div class="social-search-box" data-animate="fadeInUp" data-delay="100">
						<form action="#" method="GET">
							<div class="search-wrapper">
								<input type="text" name="search" class="search-input"
									placeholder="Cari Sosial dan Dakwah..." name="search" value="{{ request()->get('search') }}" id="search">
								<a href="#" class="search-btn" onclick="display();return false;">🔍 Cari</a>
							</div>
						</form>
					</div>
...
<script>
	...
	function display(page = 1) {
		...
		let url = `{{ url('/page-social-list') }}?search=${search}&page=${page}`;

		$.ajax({
			url: url,
			type: "GET",
			success: function(res) {
				$("#show_social").html(res);
			}
		});
	}
