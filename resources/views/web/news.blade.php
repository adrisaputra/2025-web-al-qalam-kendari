...
@extends('web.layout')
@section('content')
<link rel="stylesheet" href="{{ asset('frontend/web/news.css') }}" type="text/css" />
		...
		<div class="container clearfix">
			...
			<div class="heading-block border-0 mw-100">
				...
				<div class="row clearfix">
					...
					<div class="news-search-box" data-animate="fadeInUp" data-delay="100">
						<form action="#" method="GET">
							<div class="search-wrapper">
								<input type="text" name="search" class="search-input"
									placeholder="Cari Berita..." name="search" value="{{ request()->get('search') }}" id="search">
...
<script>
	...
	function display(page = 1) {
		...
		let url = `{{ url('/page-news-list') }}?search=${search}&page=${page}`;
