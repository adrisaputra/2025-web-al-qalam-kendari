        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-social-table-toolbar="base">
                            ...
                            <a class="btn btn-success btn-sm me-2 mb-2" data-bs-toggle="modal" data-bs-target="#kt_modal_add_social" onClick="clearForm()"><i class="fa fa-plus"></i>Tambah {{ __($title)}}</a>
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <!--begin::Table-->
                    <table class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-2 gs-6" id="social-table">
...
<script>
    ...
    $(document).ready(function () {
        table = $('#social-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('social.list') }}",
            columns: [
    ...
    function send() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#kt_modal_add_social').modal('hide');
    ...
    function getData(id){
        ...
        var url = "{{ url('/social/edit') }}";
        $.ajax({
            url: url + "/" + id,
            type: "GET",
            success: function (response) {
                document.getElementById("id_social").value = response.data.id;
                ...
                var coverLink = '<br><a href="{{ asset("storage/upload/social/") }}/' + response.data.cover + '" class="btn mb-2 mr-1 btn-sm btn-info snackbar-bg-info" target="_blank">Lihat Cover Sebelumnya</a>';
    ...
    function update(id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#kt_modal_add_social').modal('hide'); // Tutup modal setelah berhasil memperbarui data
