							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(1)=="slider") active @endif" href="{{ url('/slider') }}">
										<span class="menu-icon" style="margin-right: 15px">
											<img src="{{ asset('storage/menu/icons8-panorama-100.png') }}" width="30" height="30" >
										</span>
								...
								{{--<div data-kt-menu-trigger="click" class="menu-item @if(in_array(Request::segment(1), array('history','vision_mission','structure','area','demographics','facility'))) here show @endif menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-item">
											<a class="menu-link @if(Request::segment(1)=='facility') active @endif" href="{{ url('facility') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
								...
								<div class="menu-item">
									<a class="menu-link @if(Request::segment(1)=="work_unit") active @endif" href="{{ url('/work_unit') }}">
										<span class="menu-icon" style="margin-right: 15px">
											<img src="{{ asset('storage/menu/icons8-list-100.png') }}" width="30" height="30" >
										</span>
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="toolbar">
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								<img alt="Logo" src="{{ asset('storage/upload/setting/'.$setting->large_icon) }}" width="50%">
							</div>
							<!--end::Toolbar-->
						</div>
					</div>
