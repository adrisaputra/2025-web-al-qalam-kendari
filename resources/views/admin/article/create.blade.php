...
<div class="modal fade" id="kt_modal_add_article" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            ...
            <form id="myForm" action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_article_scroll" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_article_header" data-kt-scroll-wrappers="#kt_modal_add_article_scroll" data-kt-scroll-offset="800px">
                        
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">{{ __('Judul') }}</label>
                            <input type="hidden" class="form-control" id="id_article"/>
...
<script>
    ...
    CKEDITOR.replace('text', {
        filebrowserUploadUrl: "{{route('upload_article', ['_token' => csrf_token() ])}}",
    ...
    $('#kt_modal_add_article').on('shown.bs.modal', function() {
